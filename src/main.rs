...
impl SavedState {
    ...
    async fn save(self) -> Result<(), SaveError> {
        ...
        if let Some(dir) = path.parent() {
            debug!("{} at {}", dir.display(), Local::now());
...
//         // let local_client = Checkbox::new(
//         //     self.clients[0].client.to_string(),
//         //     self.clients[0].checked,
//         //     CarnoWSMessage::ClientChecked,
//         // );

//         let left_col = Column::new().spacing(10).padding(10);

//         // left_col.push(button("add a checkbox"));

//         // let left_col = left_col;

//         // let left_col = Column::new()
//         //     .push(button("add a checkbox"))
//         //     .push(text("client list"))
//         //     .width(Length::Fill)
//         //     .height(Length::Fill)
//         //     .padding(10)
//         //     .spacing(20);
...
//         let content = Row::new().push(left_col).push(Column::new());
